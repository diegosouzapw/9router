# 9router — Codebase Documentation

> A comprehensive, beginner-friendly guide to the **9router** multi-provider AI proxy router.

---

## 1. What Is 9router?

9router is a **proxy router** that sits between AI clients (Claude CLI, Codex, Cursor IDE, etc.) and AI providers (Anthropic, Google, OpenAI, AWS, GitHub, etc.). It solves one big problem:

> **Different AI clients speak different "languages" (API formats), and different AI providers expect different "languages" too.** 9router translates between them automatically.
...
| `src/lib/`    | Database access (`usageDb.js`), authentication, shared library code    |
