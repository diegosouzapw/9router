      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10 md:py-14 flex flex-col gap-8">
        <header className="rounded-2xl border border-border bg-bg-subtle p-6 md:p-8">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-xs uppercase tracking-wider text-text-muted">In-App Documentation</p>
              ...
              <p className="text-sm md:text-base text-text-muted mt-2 max-w-3xl">
                Quick setup, client compatibility notes, and endpoint reference to run OpenAI-compatible clients,
                Codex/Copilot models, and Cherry Studio integrations on this server.
              </p>
            </div>
            <div className="flex flex-wrap gap-2">
              ...
              <a
                href="https://github.com/decolua/9router/issues"
                target="_blank"
        ...
        <section id="quick-start" className="rounded-2xl border border-border bg-bg-subtle p-6">
          ...
          <ol className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            ...
            <li className="rounded-lg border border-border p-3 bg-bg">
              ...
              <p className="text-text-muted mt-1">Add provider accounts in Dashboard and run Test Connection.</p>
            </li>
            <li className="rounded-lg border border-border p-3 bg-bg">
            ...
            <li className="rounded-lg border border-border p-3 bg-bg">
              ...
              <p className="text-text-muted mt-1">
                Prefer explicit provider prefix, for example <code className="px-1 rounded bg-bg-subtle">gh/gpt-5.1-codex</code>.
              </p>
            </li>
          </ol>
        </section>
        ...
        <section id="client-compatibility" className="rounded-2xl border border-border bg-bg-subtle p-6">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            <article id="cherry-studio" className="rounded-lg border border-border p-4 bg-bg">
              ...
              <ul className="mt-2 text-text-muted space-y-1">
                <li>Base URL: <code className="px-1 rounded bg-bg-subtle">https://&lt;host&gt;/v1</code></li>
                <li>Chat endpoint: <code className="px-1 rounded bg-bg-subtle">/chat/completions</code></li>
                <li>Model recommendation: explicit prefix (<code className="px-1 rounded bg-bg-subtle">gh/...</code>, <code className="px-1 rounded bg-bg-subtle">cc/...</code>)</li>
              </ul>
            </article>
            <article id="codex-copilot" className="rounded-lg border border-border p-4 bg-bg">
              ...
              <ul className="mt-2 text-text-muted space-y-1">
                <li>Use model IDs with <code className="px-1 rounded bg-bg-subtle">gh/</code> prefix.</li>
                <li>Codex-family models auto-route to <code className="px-1 rounded bg-bg-subtle">/responses</code>.</li>
                <li>Non-Codex models continue on <code className="px-1 rounded bg-bg-subtle">/chat/completions</code>.</li>
              </ul>
            </article>
          </div>
        </section>
