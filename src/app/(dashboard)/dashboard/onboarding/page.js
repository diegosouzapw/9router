        ...
        <div className="bg-surface rounded-2xl border border-white/[0.06] p-8 shadow-xl">
          ...
          <div className="min-h-[200px]">
            ...
            {currentStep.id === "welcome" && (
              <div className="text-center space-y-4">
                <p className="text-text-muted">
                  <strong className="text-text-main">9Router</strong> is your local AI API proxy. It
                  routes requests to multiple AI providers with load balancing, failover, and usage
                  tracking.
                </p>
            ...
            {currentStep.id === "done" && (
              <div className="text-center space-y-4">
                <p className="text-text-muted">
                  You&apos;re all set! Your 9Router instance is configured and ready to proxy AI
                  requests.
                </p>
