    ...
    <Card>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div role="tablist" aria-label="Combo strategy" className="inline-flex p-0.5 rounded-md bg-black/5 dark:bg-white/5">
        ...
        <div className="pt-3 border-t border-border/50">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            />
            <Button variant="outline" size="sm" onClick={addProviderOverride} disabled={!newOverrideProvider.trim()}>
              Add
            </Button>
          </div>
        </div>
