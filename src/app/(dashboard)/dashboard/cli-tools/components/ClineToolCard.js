...
export default function ClineToolCard({
  ...
  const getConfigStatus = () => {
    ...
    if (!clineStatus.has9Router) return "not_configured";
              ...
              <div className="flex items-start gap-3 p-3 rounded-lg border bg-bg-secondary/50 border-border">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  {clineStatus.commandPath && (
                    <p className="text-xs text-text-muted">Binary: <code className="px-1 py-0.5 rounded bg-black/5 dark:bg-white/10">{clineStatus.commandPath}</code></p>
                  )}
                  {clineStatus.globalStatePath && (
                    <p className="text-xs text-text-muted">Config: <code className="px-1 py-0.5 rounded bg-black/5 dark:bg-white/10">{clineStatus.globalStatePath}</code></p>
                  )}
                </div>
              </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-green-500/10 border border-green-500/30 rounded-lg">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <p className="text-xs text-text-muted">
                          Provider: <strong>openai</strong> • Model: <strong>{clineStatus.settings?.openAiModelId || "—"}</strong>
                        </p>
                      </div>
                    </div>
                  )}
