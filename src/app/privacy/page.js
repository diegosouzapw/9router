...
export const metadata = {
  title: "Privacy Policy | 9Router",
  description: "Privacy policy for the 9Router AI API proxy router.",
};
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-text-muted leading-relaxed">
          <section>
            ...
            <p>
              9Router is designed as a <strong className="text-text-main">local-first</strong>{" "}
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              <code className="text-primary text-sm">~/.9router/storage.sqlite</code>:
            </p>
          ...
          <section>
            ...
            <p>
              9Router does <strong className="text-text-main">not</strong> collect telemetry,
          ...
          <section>
            ...
            <p>
              When you make API calls through 9Router, your requests are forwarded to the AI
          ...
          <section>
            ...
            <p>
              ...
              any time by removing the <code className="text-primary text-sm">~/.9router/</code>{" "}
