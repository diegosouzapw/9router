import { getCustomModels, getAllCustomModels, addCustomModel, removeCustomModel } from "@/lib/localDb";
...
export async function DELETE(request) {
  try {
    ...
    if (!provider || !modelId) {
      return Response.json(
        { error: { message: "provider and model query params are required", type: "validation_error" } },
        { status: 400 }
      );
    }
