...
export const metadata = {
  title: "Terms of Service | 9Router",
  description: "Terms of service for the 9Router AI API proxy router.",
};
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-text-muted leading-relaxed">
          <section>
            ...
            <p>
              9Router is a <strong className="text-text-main">local-first</strong> AI API proxy
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                You are responsible for the security of your local 9Router installation, including
          ...
          <section>
            ...
            <p>
              9Router acts as an intermediary proxy. API calls sent to 9Router are translated and
              forwarded to your configured AI providers. 9Router does not modify the content of your
              requests or responses beyond the necessary protocol translation.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                9Router does not transmit any data to external servers unless you explicitly enable
                cloud sync features.
              </li>
              <li>
                Usage logs, API keys, and configuration are stored in{" "}
                <code className="text-primary text-sm">~/.9router/</code>.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              9Router is provided &ldquo;as is&rdquo; without warranty of any kind. We are not
          ...
          <section>
            ...
            <p>
              9Router is open-source software. You are free to inspect, modify, and distribute it
