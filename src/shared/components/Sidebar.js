  ...
  return (
    <>
      ...
      >
        ...
        <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:z-50 focus:p-3 focus:bg-primary focus:text-white focus:rounded-md focus:m-2">
          Skip to content
        </a>
        {/* Traffic lights + collapse toggle */}
        <div className={cn("flex items-center gap-2 pt-5 pb-2", collapsed ? "px-3 justify-center" : "px-6")} aria-hidden="true">
        ...
        {/* Navigation */}
        <nav aria-label="Main navigation" className={cn("flex-1 py-2 space-y-1 overflow-y-auto custom-scrollbar", collapsed ? "px-2" : "px-4")}>
      ...
      {isDisconnected && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
          <div className="text-center p-8">
            ...
            <p className="text-text-muted mb-6">The proxy server has been stopped or is restarting.</p>
