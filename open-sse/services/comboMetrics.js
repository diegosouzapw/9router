 ...
 */
export function recordComboRequest(comboName, modelStr, { success, latencyMs, fallbackCount = 0, strategy = "priority" }) {
...
export function getComboMetrics(comboName) {
  ...
  return {
    ...
    byModel: Object.fromEntries(
      Object.entries(combo.byModel).map(([model, m]) => [model, {
        ...m,
