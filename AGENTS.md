...
- **Database**: better-sqlite3 (SQLite) — `DATA_DIR` configurable, default `~/.9router/`
...
- Data persists in named volumes (`9router-data` / `9router-prod-data`)
